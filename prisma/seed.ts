...
async function main() {
  // --- Admin user ---
  const adminEmail = process.env.ADMIN_EMAIL ?? "admin@ventronltd.com";
  ...
  const services = [
    ...
    { name: "Project Management", slug: "project-management", tagline: "Planning, supervision & commissioning support.", description: "Project planning, scheduling, site supervision, contractor management, progress reporting and commissioning.", content: "Construction management and project delivery: planning, scheduling, coordination, site supervision, contractor management, installation oversight and commissioning support.", icon: "HardHat", featured: false, order: 7 },
  ...
  // --- Statistics (editable placeholders, zero-fabrication safe) ---
  const stats = [
